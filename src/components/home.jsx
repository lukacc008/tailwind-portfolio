...
export default function Home() {
  ...
  return (
    <div
      ...
      data-aos-offset="0"
    >
      <h1 className="text-3xl md:text-4xl lg:text-4xl text-center mb-4 font-bold text-plum">
        Welcome to my online portfolio, where I showcase my journey, projects,
        and experiences!
      </h1>
      <p className="text-lg md:text-xl lg:text-2xl text-center text-plum mt-20">
